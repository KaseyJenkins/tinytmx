[![CMakeLinux](https://github.com/KaseyJenkins/tinytmx/actions/workflows/CMakeLinux.yml/badge.svg)](https://github.com/KaseyJenkins/tinytmx/actions/workflows/CMakeLinux.yml)
[![CMakeWindows](https://github.com/KaseyJenkins/tinytmx/actions/workflows/CMakeWindows.yml/badge.svg)](https://github.com/KaseyJenkins/tinytmx/actions/workflows/CMakeWindows.yml)
[![CMakeMacOS](https://github.com/KaseyJenkins/tinytmx/actions/workflows/CMakeMacOS.yml/badge.svg)](https://github.com/KaseyJenkins/tinytmx/actions/workflows/CMakeMacOS.yml)
...
Fully supports TMX Map Format `version 1.8`.


## Features

* Conformity with the [TMX specification page](http://doc.mapeditor.org/en/latest/reference/tmx-map-format/).
    * (Currently supports TMX Map Format `version 1.8`. Earlier versions are not officially supported.)
