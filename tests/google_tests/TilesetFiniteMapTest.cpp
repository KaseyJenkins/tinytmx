...
class MainTestTrialTileset : public ::testing::Test {
protected:

    void SetUp() override {
        fileName = "assets/TilesetFiniteOrthogonalMap.tmx";
...
TEST_F(MainTestTrialTileset, Map) {
...
TEST_F(MainTestTrialTileset, MapCustomProperties) {
...
TEST_F(MainTestTrialTileset, Layer) {
...
TEST_F(MainTestTrialTileset, EmbeddedTileset) {
...
TEST_F(MainTestTrialTileset, EmbeddedTilesetImage) {
...
TEST_F(MainTestTrialTileset, EmbeddedTilesetOffset) {
...
TEST_F(MainTestTrialTileset, EmbeddedTilesetGrid) {
...
TEST_F(MainTestTrialTileset, EmbeddedTilesetProperties) {
...
TEST_F(MainTestTrialTileset, EmbeddedTilesetTransformations) {
